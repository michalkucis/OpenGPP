...
{
public:
	AppInputTest (string testName, int countRenders = 1): UnitTest (testName) 
	{
...
public:
	...
	Ptr<Input> createInput ()
	{
		return new InputLoadFromSequence<InputLoadFromSingleFileOpenEXR>(GeneratorOfInputSequenceFilenames ("img_movingscene_",".exr",0,3,1));
	}
...
public:
	...
	Ptr<Input> createInput ()
	{
		return new InputLoadFromSequence<InputLoadFromSingleFileOpenEXR>(GeneratorOfInputSequenceFilenames ("img_movingscene_",".exr",0,3,1), int2(800,800), InputLoadFromSingleFileOpenEXR::LINEAR);
	}
